...
static void DrawGameplay1Menu(void)
{
    ...
    if (english_language)
    {
        ...
        // Fake contrast
        RD_M_DrawTextSmallENG(fake_contrast ? "ORIGINAL" : "OFF", 143 + wide_delta, 52,
    ...
    else
    {
        ...
        RD_M_DrawTextSmallRUS(fake_contrast ? "JHBUBYFKMYFZ" : "DSRK", 205 + wide_delta, 52,
                              fake_contrast ? CR_GREEN : CR_RED);
...
void MN_DrawInfo(void)
{
    ...
    switch(InfoType)
    {
        case 0:
        {
            if(isDK)
            {
                lump_name = english_language ? "TITLEDK" : "TITLEDKR";
            }
            else
            {
                lump_name = "TITLE";
        ...
        case 1:
        {
            lump_name = english_language ? "HELP1" : "RD_HELP1";
            break;
        }
        case 2:
        {
            lump_name = english_language ? "HELP2" : "RD_HELP2";
            break;
        }
        case 3:
        {
            if(isDK)
            {
                lump_name = english_language ? "CREDITDK" : "RD_CREDK";
            }
            else
            {
                lump_name = english_language ? "CREDIT" : "RD_CREDT";
            }
            break;
        }
        default:

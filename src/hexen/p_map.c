...
= more than halfway off of ledges, and allows objects to roll off of the edges
= of moving lifts, or = to slide up and then back down stairs, or to fall
= into a ditch. If more than one linedef is contacted, the effects are 
= cumulative, so balancing is possible.
=
================================================================================
*/
...
fixed_t P_AimLineAttack(mobj_t * t1, angle_t angle, fixed_t distance)
{
    ...
    else
    {
        ...
        const fixed_t factor = (screenblocks <= 10) ? 158 : 146;
